...
public class Arithmetic {
    ...
    public static ArrayList<Integer> doOperation(ArrayList<Integer> arr1, ArrayList<Integer> arr2 , Operation operation) {
    ...
    public static ArrayList<Integer> andAll(ArrayList<String> array, HashMap<String, ArrayList<Integer>> tokens) {
        return array.stream().map(a -> tokens.get(a)).reduce((a, b) -> Arithmetic.doOperation(a, b,Operation.AND)).orElse(new ArrayList<>());
    }
